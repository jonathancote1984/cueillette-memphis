...
1. Ouvrez **aistudio.google.com/apikey** (clé gratuite, avec un compte Google).
2. Cliquez sur **Create API key**.
3. **Copiez** la clé (elle commence par `AIza`).

## ➕ Ajouter la clé dans l'app

1. Onglet **⚙️ Paramètres** → section **🔑 Clé API Gemini**.
2. **Collez** votre clé dans le champ (il est masqué).
...
### Illustrations
1. Dans la fiche d'une variété → **🎨 Illustration IA** (ou **✨ Générer les manquantes**).
2. L'app génère une image par spécificité. Vous pouvez en refaire une à la fois si elle ne convient pas.
